...
// ///////////////////////////////////PICTURE TAKING OPERATION//////////////////////////////////////////////////
    ...
    if (digitalRead(S1) == LOW && digitalRead(Selector) ==  HIGH && shots == 0)          //NORMAL OPERATION
     ...
     // CASE 2 DOUBLE EXPOSURE FIRST SHOT: MIRROR DOWN AND FIRST PICTURE (CLICK: SHUTTER OPERATION REMAINING CLOSED)           
     if (digitalRead(S1) == LOW && digitalRead(Selector) ==  LOW && shots == 0)    //DOUBLE EXPOSURE and RED S1 PRESSED (S1) FIRST SHOT!!!!
      {
         analogWrite (GREENled, 255);
          ...
          } // end of if if (digitalRead(S1) == LOW && digitalRead(Selector) ==  LOW && shots == 0)    //DOUBLE EXPOSURE and RED S1 PRESSED (S1) FIRST SHOT!!!!

         // CASE 3 DOUBLE EXPOSURE ULTERIOR SHOTS: NO MOTOR OPERATION JUST PICTURE (CLICK: SHUTTER OPERATION REMAINING CLOSED)  
         if (digitalRead(S1) == LOW && digitalRead(Selector) ==  LOW && shots >= 1)    //DOUBLE EXPOSURE and RED S1 PRESSED (S1) ULTERIOR SHOTS!!!!
          {
          Click();
          ...
          } // end of  if (digitalRead(S1) == LOW && digitalRead(Selector) ==  LOW && shots >= 1)    //DOUBLE EXPOSURE and RED S1 PRESSED (S1) ULTERIOR SHOTS!!!!
...
void Click()
{
  ...
  if (ActualSlot == 0)                                        //THIS IS THE B "BULB" OPTION WHILE S1 (Red SHUTTER S1 is pressed) the shutter is OPEN
  { ;
  ...
  if (ActualSlot == 9)
  { ;
    while (digitalRead(S1) == HIGH );                        //THIS IS THE T "TIME" OPTION PRESS ONCE S1 (Red SHUTTER S1) the shutter is OPEN and AGAIN to close
    shutterCLOSE ();
    return;
  }
...

{
  ...
  if (digitalRead(S1) == HIGH) {
    ...
    if ((millis() - S1Timer > longPressTime) && (longPressActive == false)) {
